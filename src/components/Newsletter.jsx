...
const Newsletter = () => {
    ...
    return (
        <div class="desktop:bg-neutral desktop:w-full">
            <img class="desktop:hidden lg:hidden andriod:w-[412px] mobile:block mobile:w-[375px]" src={HeroMobile} alt='illustration' />
            <div class="desktop:max-w-[720px] lg:max-w-[720px] mx-auto bg-neutral-100 desktop:py-4 desktop:m-8 mt-[15px] rounded-3xl h-[500px] grid md:grid-cols-2 lg:mt-8">
                ...
                <div class="desktop:pr-3 lg:py-14 mobile:pl-[10px] desktop:pl-5 desktop:ml-8 mr-5 align-items w-[100%] mobile:mx-[20px] andriod:mx-[30px] mr-1 mx-[5px] ">

                    <h1 class="text-neutral-900 font-bold desktop:mt-[10px] desktop:text-[42px] mobile:text-4xl andriod:text-5xl andriod:mt-[25px]">Stay updated!</h1>
                    <p class="pt-4 pb-4 mobile:pb-2 mr-[40px] mobile:mr-[50px] text-neutral-800 text-[12px] ">
                        Join 60,000+ product managers receiving monthly updates on:
                    </p>
                    <div class="text-[12px] text-neutral-800 andriod:mt-[20px] mobile:w-[300px] desktop:w-[100%]">
                        <ul >
                            <li class="flex ">
                                <img src={Listick} alt='tick' />
                               <span class="m-3 andriod:m-4"> Product discovery and building what matters</span>
                            </li>

                            <li class="flex ">
                                <img src={Listick} alt='tick' />
                               <span class="m-3 andriod:m-4">Measuring to ensure updates are a success </span> 
                            </li>

                            <li class="flex ">
                                <img class="" src={Listick} alt='tick' />
                            <span class="m-3 andriod:m-4"> And much more!</span>
                            </li>
                        </ul>
                    </div>

                    <form onSubmit={handleSubmit}>
                    <div class="mobile:w-[80%] desktop:w-[90%] andriod:mt-[35px] ">
                        ...
                        <button type="submit" class="bg-neutral-900 text-neutral-100  w-[100%] mt-4 text-sm h-[45px] rounded-lg  tracking-wider hover:bg-gradient-to-r from-primary-500 to-primary-400 hover:shadow-4xl focus:outline-none focus:ring-6 focus:ring-primary-400 focus:ring-opacity-50 andriod:mt-8">
